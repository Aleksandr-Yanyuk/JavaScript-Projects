I created a working calculator application styled and created with HTML CSS and the business logic came from the javaScript. Working application with functions such as add, subtract, multiply, divide.
